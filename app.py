...
def get_stock_name(stock_code):
    ...
    stock_map = {
        ...
        "00632R": "元大台灣50反1", "00679B": "元大美債20年", "00687B": "國泰20年美債",
        ...
        "2344": "華邦電", "5347": "世界先進", "6770": "力積電",
        
        # --- AI/電腦週邊 ---
        "2353": "宏碁", "2324": "仁寶", "3017": "奇鋐", "3324": "雙鴻",
        "2376": "技嘉", "2377": "微星", "3293": "鈊象",
        
        # --- 航運/傳產 ---
        "2603": "長榮", "2609": "陽明", "2615": "萬海", "2618": "長榮航",
        "2610": "華航", "2002": "中鋼", "1101": "台泥", "1102": "亞泥",
        "1605": "華新", "6505": "台塑化", "1301": "台塑", "1303": "南亞",
        "1326": "台化", "9910": "豐泰", "9904": "寶成",
    ...
    # 2. 如果字典裡沒有，嘗試用 twstock (如果剛好有安裝成功的話)
    try:
        import twstock
